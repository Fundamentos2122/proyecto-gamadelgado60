...
if($_SERVER["REQUEST_METHOD"]=="GET")
{
    ...
    if(array_key_exists("id",$_GET))
    {
        ...
        {
            $idus = $_SESSION["id"];
            $query = $connection->prepare("SELECT * FROM carrito,producto WHERE id_usuario = $idus AND id_Producto = id");
            $query->execute();
                    ...
                    "<div class='row prod'>".
                        ...
                        "<div class='col-md-8 col-6'>".
                            "<div class='row'>".
                                ...
                                "<div class='col-2'><a href='eliminarcarprod.php?id=" . $producto->getId() ."'><img src='../imagenes/basu.svg' alt='' class='icon-md'></a></div>".
...
else if($_SERVER["REQUEST_METHOD"]== "POST")
{
    if($_POST["_method"]=="POST")
    {
        ...
        try{
            $query = $connection->prepare('INSERT IGNORE INTO carrito VALUES(NULL,:id_producto, :id_usuario)');
            ...
            header("Location: http://localhost/wahwah/views/carritos.php");
        }
        catch(PDOException $e)
        {
            error_log("Error en query - " . $e,0);
    ...
    }else if($_POST["_method"]=="DELETE")
    {
        ...
        $id_usuario = $_POST["idus"];
        try{
            $query = $connection->prepare('DELETE FROM carrito WHERE id_producto= :id_producto AND id_usuario = :id_usuario');
            $query->bindParam(':id_producto',$id_producto, PDO::PARAM_INT);
            $query->bindParam(':id_usuario',$id_usuario, PDO::PARAM_INT);
            $query->execute();
            if($query->rowCount ()==0)
